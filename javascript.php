...
<div class="container-fluid">
    <form method="post" action="result/javascript.php" name="myForm" id="quiz" onsubmit="return validateForm()">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើនៅខាងក្នុងធាតុ HTML យើងដាក់ JavaScript មួយណា?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើកន្លែងណាដែលត្រឹមត្រូវក្នុងការដាក់បញ្ចូល JavaScript?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើមួយណាជា syntax ដែលត្រឹមត្រូវសម្រាប់ external script ដែលបានហៅនៃ "---.js"?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ external JavaScript file គួរតែមានប្រើនូវ &lt;script&gt; tag ឬទេ?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើអាចសរសេរនូវពាក្យថា "Hello World" ក្នុង alert box យ៉ាងដូចម្តេច?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើអ្នកបង្កើត function ក្នុង JavaScript យ៉ាងមិច?</h5>
