...
<div class="container-fluid">
    <form method="post" action="result/network.php" name="myForm" id="quiz" onsubmit="return validateForm()">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ NetWork Topology មានចំនួនប៉ុន្នាន?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ Computer Network មានប៉ុន្នានប្រភេទ?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ កាគ្រប់គ្រង់ប្រព៏ន្ធ ឬ (Network Configuration) មានចំនួនប៉ុន្មានប្រភេទ?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ Network Media មានចំនួនប៉ុន្មានប្រភេទ?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ Twisted Pair Cable ត្រូវបានបែងចែកជាប៉ុន្មានប្រភេទ?</h5>
            ...
            <div class="col go-down">
                ...
                <div>
                    ...
                    <h5>តើ LAN មានពាក្យពេញជាអ្វី?</h5>
                    ...
                    <div>
                        ...
                        A) Local Airlines Network </label>
                    </div>
